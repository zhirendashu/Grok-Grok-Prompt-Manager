...
(function () {
    ...
    const ICON_SET = {
        ...
        HD: `<svg class="gpm-svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18" fill="none"></rect>
        ...
        DelLib: `<svg class="gpm-svg-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 21.5c-3.11 0-6.13-2.07-7.91-5.18a9.42 9.42 0 0 1 1.76-10.76l.16-.17a1 1 0 0 1 1.42 0l.16.17a6.6 6.6 0 0 0 8.82 0l.16-.17a1 1 0 0 1 1.42 0l.16.17a9.42 9.42 0 0 1 1.76 10.76C18.13 19.43 15.11 21.5 12 21.5z"></path>
            <path d="M12 8v5"></path>
            <path d="M9 11h6"></path>
        </svg>`,

        // --- 💾 Memory Chip (Save/Library) -> NOW: IMPORT ---
