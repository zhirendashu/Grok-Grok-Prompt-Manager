...
(function () {
        ...
        defaultSchema() {
            return {
                ...
                settings: {
                    ...
                    panels: {
                        left: { collapsed: false, width: 300, height: 700, top: 80, left: 20 },
                        right: { collapsed: false, width: 300, height: 700, top: 80, right: 20 },
    ...
    class SidePanel extends Component {
        constructor(styleManager, config = { side: 'left', width: 380 }) {
            ...
            this.leftPos = config.left || 20; // renamed to avoid conflict with 'left' string
            this.rightPos = config.right || 20;
            this.isCollapsed = config.collapsed || false;
            this.onStateChange = config.onStateChange; // ✨ New Callback
        }
