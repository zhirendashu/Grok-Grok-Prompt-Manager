        ...
        afterRender() {
            ...
            if (diceBtn) {
                diceBtn.onclick = (e) => {
                    ...
                    const opts = [
                        { label: '🎲 随机抽取 (Random 3)', act: 'random3' },
                        { label: '🎨 分类混合 (Cat. Mix)', act: 'catmix' },
                        { label: '🌀 完全混乱 (Chaos)', act: 'chaos' }
                    ];
        ...
        _sendContent(content, isReplace) {
            ...
            if (isDraftOpen) {
                ...
                if (isReplace) {
                    ...
                    this.showToast('已智能替换草稿 (Smart Replace Draft)');
                } else {
                ...
                if (isReplace) {
                    ...
                    this.showToast('已替换/插入 (Smart Replace)');
                } else {
